...
const LIFE_CHOICES = {
  22: {
    ...
    choices: [
      ...
      },
      {
        ...
        immediateEffects: { debt: 20000, knowledge: 20, happiness: 5 },
      ...
      },
      {
        ...
        immediateEffects: { savings: -10000, happiness: 20, network: 15, knowledge: 10 },
  ...
  40: {
    ...
    icon: '🏔️',
    age: 40,
    description: '40岁了。"四十而不惑"。你对人生还有困惑吗？前半生的积累，后半生要怎么用？',
    isLifeChoice: true,
    choices: [
      {
        id: 'mentor',
        ...
        shortName: '传承经验',
        icon: '👨‍🏫',
        description: '把前半生的经验传给年轻人，做公司里的导师',
        immediateEffects: { salaryMultiplier: 1.05, network: 15, happiness: 10, knowledge: 10 },
        midTermEffects: { salaryGrowthMultiplier: 0.9, layoffResistance: 0.7, respectBonus: true },
        longTermEffects: { careerLine: 'mentor', mentorEndingPossible: true, workLifeBalance: true },
        unlocks: ['mentor_path'],
        resultText: '你选择传承经验。工资+5%，人脉+15，幸福+10，学识+10。工资增长变慢，但被裁员风险降低70%，更受尊重，工作生活更平衡。',
        parallelHook: '如果你40岁选择二次创业，现在可能已经财务自由，也可能负债累累。你选择了稳妥——传承也是一种价值。'
      },
      {
        id: 'secondstartup',
        text: '二次创业，利用经验再搏一把',
        shortName: '二次创业',
        icon: '🚀',
        description: '40岁有经验有人脉有积蓄，正是创业的好时机',
        immediateEffects: { salary: 8000, savings: -80000, debt: 150000, happiness: 15, network: 25, knowledge: 20 },
        midTermEffects: { incomeVolatility: 2.0, startupSuccessChance: 0.35, salaryGrowthMultiplier: 0 },
        longTermEffects: { careerLine: 'second_entrepreneur', startupEndingPossible: true, familyPressure: true, midlifeCrisisAvoided: true },
        unlocks: ['second_startup'],
        resultText: '你选择40岁二次创业！投入80万积蓄，借了150万，工资降到8000（创业初期收入）。幸福+15，人脉+25，学识+20。成功概率35%（比25岁高），但上有老下有小，压力巨大。',
        parallelHook: '如果你40岁选择安稳上班，现在可能平平淡淡但没有风险。你选择了再搏一把——40岁的创业，有经验但也输不起。'
      },
      {
        id: 'familyfirst',
        text: '回归家庭，把重心放在家人身上',
        shortName: '回归家庭',
        icon: '👨‍👩‍👧‍👦',
        description: '前半生为事业打拼，后半生多陪陪家人',
        immediateEffects: { salaryMultiplier: 0.8, happiness: 25, health: 15, baseExpenseMultiplier: 1.1, network: 5 },
        midTermEffects: { salaryGrowthMultiplier: 0.6, familyEvents: true, childEducationBonus: true },
        longTermEffects: { careerLine: 'family_first', familyEndingPossible: true, careerCeiling: true, happinessCapBonus: 30 },
        unlocks: ['family_first'],
        resultText: '你选择回归家庭。工资降到80%，但幸福+25，健康+15，支出+10%，人脉+5。工资增长变慢，但家庭关系更和睦，子女教育更好，职业天花板降低了但人生更圆满。',
        parallelHook: '如果你40岁继续拼事业，现在可能职位更高收入更多，但可能错过了孩子的成长和父母的晚年。你选择了家庭——有些东西钱买不到。'
      },
      {
        id: 'crossover',
        text: '跨界突破，打破中年困局',
        shortName: '跨界突破',
        icon: '🌅',
        description: '放弃现有行业积累，跨界到更有前景的新领域',
        immediateEffects: { salaryMultiplier: 0.6, knowledge: 25, happiness: 10, network: -15, health: -5 },
        midTermEffects: { salaryGrowthMultiplier: 2.5, newIndustry: true, learningCurve: true },
        longTermEffects: { careerLine: 'crossover', salaryCapMultiplier: 1.5, oldIndustryWasted: true, midlifeRebirth: true },
        unlocks: ['crossover'],
        resultText: '你选择跨界突破！工资降到60%（重新开始），但学识+25，幸福+10，人脉-15（旧人脉用不上），健康-5（学习压力大）。新行业增长快，工资增长速度2.5倍，但之前的行业积累白费了。40岁重新开始，需要勇气。',
        parallelHook: '如果你40岁留在原行业，现在可能是资深专家，但也可能遇到了行业衰退。你选择了跨界——40岁的重新开始，是勇气还是冒险？'
      }
    ]
  },
  50: {
    ...
    icon: '🌄',
    age: 50,
    description: '50岁了。"五十而知天命"。你知道自己的使命了吗？人生过半，剩下的时间要怎么过？',
    isLifeChoice: true,
    choices: [
      {
        id: 'peak',
        ...
        shortName: '事业巅峰',
        icon: '🏆',
        description: '趁着还有精力，冲击最高职位或最大成就',
        immediateEffects: { salaryMultiplier: 1.3, health: -15, happiness: -5, network: 20 },
        midTermEffects: { salaryGrowthMultiplier: 1.5, promotionChanceBonus: 0.3, healthRisk: true },
        longTermEffects: { careerLine: 'peak_chaser', careerSuccessEndingPossible: true, healthAfter55Risk: true },
        unlocks: ['peak_chaser'],
        resultText: '你选择冲击事业巅峰！工资+30%，但健康-15，幸福-5，人脉+20。工资增长快，晋升概率+30%，但55岁后健康风险大增。50岁再拼一把，成了就是人生巅峰，败了可能赔上健康。',
        parallelHook: '如果你50岁选择退居二线，现在可能身体更好，有更多时间享受人生。你选择了最后一搏——50岁的冲刺，值不值？'
      },
      {
        id: 'secondline',
        text: '退居二线，做顾问/投资',
        shortName: '退居二线',
        icon: '☕',
        description: '降低工作强度，做顾问或投资，享受人生',
        immediateEffects: { salaryMultiplier: 0.5, health: 15, happiness: 20, investments: 50000, knowledge: 10 },
        midTermEffects: { salaryGrowthMultiplier: 0.3, investmentReturnMultiplier: 1.2, freeTime: true },
        longTermEffects: { careerLine: 'second_line', peacefulEndingPossible: true, workLifeBalance: true, incomeVolatility: 1.5 },
        unlocks: ['second_line'],
        resultText: '你选择退居二线。工资降到50%，但健康+15，幸福+20，投资+5万（开始做投资），学识+10。工资增长慢，但投资回报率+20%，时间自由了。收入不稳定，但人生更从容。',
        parallelHook: '如果你50岁继续拼，现在可能职位更高收入更多，但身体可能已经垮了。你选择了退一步——海阔天空。'
      },
      {
        id: 'children',
        text: '培养子女，把资源传给下一代',
        shortName: '培养子女',
        icon: '🎓',
        description: '把时间、金钱和经验都投入到子女教育上',
        immediateEffects: { savings: -100000, happiness: 15, network: 10, baseExpenseMultiplier: 1.2 },
        midTermEffects: { childEducationBonus: true, familyEvents: true, salaryGrowthMultiplier: 0.7 },
        longTermEffects: { careerLine: 'children_first', familyEndingPossible: true, nextGenerationSuccess: true, retirementSupport: true },
        unlocks: ['children_first'],
        resultText: '你选择培养子女。花了10万在子女教育上，幸福+15，人脉+10，支出+20%。工资增长变慢，但子女教育更好，未来可能更有出息，退休后子女支持更多。50岁的投资，回报在下一代。',
        parallelHook: '如果你50岁把钱花在自己身上，现在可能更享受人生。你选择了投资下一代——父母之爱子，则为之计深远。'
      },
      {
        id: 'dream',
        text: '追寻梦想，做年轻时没做的事',
        shortName: '追寻梦想',
        icon: '✨',
        description: '人生过半，该为自己活一次了，去做年轻时想做但没做的事',
        immediateEffects: { salaryMultiplier: 0.3, savings: -50000, happiness: 35, health: 10, knowledge: 20 },
        midTermEffects: { salaryGrowthMultiplier: 0, dreamPursuit: true, personalGrowth: true },
        longTermEffects: { careerLine: 'dream_chaser', selfActualizationEndingPossible: true, incomeRisk: true, noRegret: true },
        unlocks: ['dream_chaser'],
        resultText: '你选择追寻梦想！工资降到30%（兼职或自由职业），花了5万追求梦想，但幸福+35，健康+10，学识+20。工资不再增长，但你终于在做自己喜欢的事。收入不稳定，但人生无憾。50岁，为自己活一次。',
        parallelHook: '如果你50岁继续上班，现在可能更有钱，但可能临死前后悔"这辈子都在为别人活"。你选择了为自己活——有些梦想，再不追就晚了。'
      }
    ]
  },
  60: {
    ...
    icon: '🌅',
    age: 60,
    description: '60岁了。"六十而耳顺"。到了退休年龄，你的人生要怎么收尾？',
    isLifeChoice: true,
    choices: [
      {
        id: 'retire',
        ...
        shortName: '正式退休',
        icon: '🏖️',
        description: '辛苦了一辈子，该歇歇了，含饴弄孙，享受人生',
        immediateEffects: { salary: 0, pension: 4000, happiness: 30, health: 20, baseExpenseMultiplier: 0.8 },
        midTermEffects: { retirementLife: true, familyEvents: true, healthBonus: true },
        longTermEffects: { careerLine: 'retiree', peacefulEndingPossible: true, longevityBonus: true, noWorkStress: true },
        unlocks: ['retiree'],
        resultText: '你选择正式退休！工资清零，开始领养老金4000/月。幸福+30，健康+20，支出-20%。没有工作压力，时间完全自由，可以含饴弄孙，旅游养生。60岁，终于可以为自己活了。',
        parallelHook: '如果你60岁继续工作，现在可能收入更高，但也可能累垮了身体。你选择了退休——辛苦了一辈子，该歇歇了。'
      },
      {
        id: 'consultant',
        text: '返聘/顾问，发挥余热',
        shortName: '返聘顾问',
        icon: '💼',
        description: '不做全职了，做兼职顾问或返聘，时间自由收入不错',
        immediateEffects: { salary: 6000, happiness: 15, health: 5, network: 10, knowledge: 10 },
        midTermEffects: { partTimeWork: true, flexibleHours: true, salaryGrowthMultiplier: 0 },
        longTermEffects: { careerLine: 'consultant', respectedEndingPossible: true, workLifeBalance: true, gradualRetirement: true },
        unlocks: ['consultant'],
        resultText: '你选择返聘做顾问！工资6000/月（兼职），幸福+15，健康+5，人脉+10，学识+10。时间自由，不用坐班，用经验赚钱。既不会太无聊，也不会太累。60岁，发挥余热，受人尊重。',
        parallelHook: '如果你60岁正式退休，现在可能更清闲，但也可能觉得无聊和失落。你选择了返聘——老有所为，也是一种幸福。'
      },
      {
        id: 'oldstartup',
        text: '60岁创业，人生最后一搏',
        shortName: '60岁创业',
        icon: '🔥',
        description: '60岁怎么了？有经验有人脉有积蓄，正是创业的好时候',
        immediateEffects: { salary: 5000, savings: -100000, debt: 100000, happiness: 20, network: 30, knowledge: 25 },
        midTermEffects: { incomeVolatility: 2.0, startupSuccessChance: 0.3, healthRisk: true },
        longTermEffects: { careerLine: 'old_entrepreneur', startupEndingPossible: true, legacyPossible: true, familyPressure: true },
        unlocks: ['old_startup'],
        resultText: '你选择60岁创业！投入100万积蓄，借了100万，工资5000/月。幸福+20，人脉+30，学识+25。成功概率30%，但有一辈子的经验和人脉。成了就是留下一份事业，败了就是养老钱打水漂。60岁，人生最后一搏。',
        parallelHook: '如果你60岁安稳退休，现在可能正在含饴弄孙，享受天伦之乐。你选择了创业——60岁的搏杀，是勇气还是执念？'
      },
      {
        id: 'legacy',
        text: '公益/传承，留下精神财富',
        shortName: '公益传承',
        icon: '📖',
        description: '做公益、写书、带徒弟，把一辈子的经验和智慧传下去',
        immediateEffects: { salary: 2000, savings: -30000, happiness: 25, health: 10, network: 20, knowledge: 15 },
        midTermEffects: { publicWelfare: true, writingOrTeaching: true, respectBonus: true },
        longTermEffects: { careerLine: 'legacy_builder', legacyEndingPossible: true, selfActualization: true, noRegret: true, spiritualWealth: true },
        unlocks: ['legacy'],
        resultText: '你选择公益传承！工资2000/月（公益或版税），花了3万做公益或出书，但幸福+25，健康+10，人脉+20，学识+15。钱不多，但你在做有意义的事，受人尊重，精神富足。60岁，留下的不只是钱，还有智慧和精神。',
        parallelHook: '如果你60岁只想着赚钱，现在可能更有钱，但死后什么都留不下。你选择了传承——有些人死了，但他还活着。'
      }
    ]
  }
};
...
const PARALLEL_HOOKS = {
  ...
  notChosen: {
    ...
    40: {
      mentor: '你40岁选择了传承经验。如果你当年二次创业，现在可能已经财务自由，也可能负债累累。',
      secondstartup: '你40岁选择了二次创业。如果你当年安稳上班，现在可能平平淡淡但没有风险。',
      familyfirst: '你40岁选择了回归家庭。如果你当年继续拼事业，现在可能职位更高，但错过了孩子的成长。',
      crossover: '你40岁选择了跨界突破。如果你当年留在原行业，现在可能是资深专家，但也可能遇到了行业衰退。'
    },
    50: {
      peak: '你50岁选择了冲击事业巅峰。如果你当年退居二线，现在可能身体更好，有更多时间享受人生。',
      secondline: '你50岁选择了退居二线。如果你当年继续拼，现在可能职位更高，但身体可能已经垮了。',
      children: '你50岁选择了培养子女。如果你当年把钱花在自己身上，现在可能更享受人生。',
      dream: '你50岁选择了追寻梦想。如果你当年继续上班，现在可能更有钱，但可能临死前后悔这辈子都在为别人活。'
    },
    60: {
      retire: '你60岁选择了正式退休。如果你当年继续工作，现在可能收入更高，但也可能累垮了身体。',
      consultant: '你60岁选择了返聘顾问。如果你当年正式退休，现在可能更清闲，但也可能觉得无聊和失落。',
      oldstartup: '你60岁选择了创业。如果你当年安稳退休，现在可能正在含饴弄孙，享受天伦之乐。',
      legacy: '你60岁选择了公益传承。如果你当年只想着赚钱，现在可能更有钱，但死后什么都留不下。'
    }
  },
  // 基于玩家状态的通用钩子（P4强化：更扎心、更有画面感、覆盖更多状态）
  generic: {
    noSideIncome: '你一辈子都在靠工资生活。你还记得25岁那年吗？朋友拉你一起做副业，你说"我还是专注主业吧"。如果当时你答应了，现在可能副业收入已经超过主业，30岁就能自由职业了。',
    noInvestment: '你一直把钱存在银行。你还记得30岁那年吗？同事劝你买点指数基金，你说"股市有风险"。如果当时你听了，现在可能资产已经翻倍了，而不是眼睁睁看着通货膨胀把你的存款一点点吃掉。',
    poorHealth: '你一直忽略健康。你还记得30岁那年吗？体检报告上有几个箭头，你说"年轻，没事"。如果当时你开始健身，现在可能身体还很硬朗，而不是这里痛那里痛，每天吃药比吃饭还准时。',
    noMarriage: '你一直专注事业。40岁那年除夕夜，你一个人吃了碗泡面，看着朋友圈里别人晒的全家福。你想起了25岁那年那个被你拒绝的表白。如果当时你接受了，现在可能正在给孩子讲睡前故事，而不是一个人对着空荡荡的房子发呆。',
    highDebt: '你被债务压了一辈子。你还记得25岁那年吗？你冲动消费买了很多不需要的东西，从那以后就一直在还债。如果当时你没有那么冲动，现在可能已经无债一身轻了，而不是每个月发工资第一件事就是还债。',
    noLearning: '你毕业后就没再学习过。你还记得22岁那年吗？你说"终于不用学习了"。如果当时你每年花1000块学一个新技能，现在可能已经是跨界人才了，而不是看着年轻人用你听不懂的术语讨论问题，心里暗暗焦虑。',
    noHouse: '你一直没买房。你还记得30岁那年吗？你看着房价一路上涨，说"再等等，会跌的"。如果当时你咬咬牙买了，现在可能已经有了自己的家，而不是还在租房，每次房东涨房租你都要搬家，心里骂着"早知道就买了"。',
    noChildren: '你选择了丁克。你还记得30岁那年吗？你说"孩子太麻烦了"。如果当时你选择了生孩子，现在可能正在陪孩子写作业，虽然累但也幸福，而不是老了以后看着别人含饴弄孙，心里有点空落落的。',
    noFriends: '你一直独来独往。你还记得25岁那年吗？朋友约你聚会，你说"没时间"。如果当时你多参加一些社交，现在可能有一群可以随时打电话的朋友，而不是遇到困难的时候翻遍通讯录，发现没有一个可以倾诉的人。',
    highSavingsLowInvest: '你存了很多钱，但都在银行里吃利息。你还记得35岁那年吗？你看着存款数字很有安全感。如果当时你拿一部分出来投资，现在可能已经财务自由了，而不是还在为了那点利息精打细算，心里想着"如果当时我勇敢一点"。',
    earlyCareerPeak: '你年轻时就达到了事业高峰，但后来一直在走下坡路。你还记得30岁那年吗？你是公司最年轻的主管。如果当时你没有停止学习，现在可能已经是高管了，而不是看着后来居上的年轻人指挥你，心里五味杂陈。',
    missedOpportunity: '你错过了一个又一个机会。你还记得35岁那年吗？有个朋友拉你一起创业，你说"太冒险了"。如果当时你答应了，现在可能已经是老板了，而不是看着那个朋友功成名就，心里想着"如果当时我勇敢一点"。'
  }
};
