...
const SCENARIOS = [
  {
    id: 'graduate', name: '应届生', icon: '🎓', age: 22,
    ...
    city: 'newGraduate', difficulty: '简单',
    tips: '你的优势是年轻和学习能力强，早点开始投资和学习，复利效应会非常明显。'
  },
  {
    id: 'newbie', name: '职场新人', icon: '💼', age: 25,
    ...
    city: 'tier1', difficulty: '普通',
    tips: '你有一定的工作经验，但也背负了一些债务。先还清高息负债，再开始投资。'
  },
  {
    id: 'senior', name: '资深职场', icon: '👔', age: 32,
    ...
    city: 'tier1', difficulty: '困难',
    tips: '你的收入高，但支出也高。注意健康管理，优化资产配置，构建被动收入。'
  },
  {
    id: 'startup', name: '创业者', icon: '🚀', age: 28,
  ...
  {
    id: 'freelance', name: '自由职业', icon: '🎨', age: 27,
    ...
    city: 'tier2', difficulty: '普通',
    tips: '你的技能是最大的资产。持续提升技能，建立稳定客户群，同时注意社保和保险。'
  },
  {
    id: 'debt', name: '负债上岸者', icon: '⛰️', age: 26,
